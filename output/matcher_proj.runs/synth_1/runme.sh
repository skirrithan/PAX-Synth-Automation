...
HD_PWD='C:/Users/Dell/Documents/Verilog Projects/PAX/Synth-Automation/PAX-Synth-Automation/output/matcher_proj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log matcher.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source matcher.tcl
